...
File 3-print_alphabet_x10.c is a function that prints 10 times the alphabet, in lowercase, followed by a new line.

File 4-islower.c is a function that checks for lowercase character.

File 5-isalpha.c is a function that checks for alphabetic character.

File 6-sign.c is a function that prints the sign of a number.

File 7-abs.c is a function that computes the absolute value of an integer.
